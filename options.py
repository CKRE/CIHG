...
def args_parser():
    ...
    parser.add_argument("--clause", type=bool, default=False)
    ...
    # training
    parser.add_argument("--n_epochs", type=int, default=1000, help="usually 50 for top50 codes, 100 for full set, 1-10 for fine tuning")
    ...
    parser.add_argument("--optimizer", type=str, default="Adam", choices=['Adam', 'AdaX', 'AdamW'])
    ...
    parser.add_argument("--my_debug", type=bool, default=False)
