...
def write_discharge_summaries_raw(out_file, min_sentence_len, notes_file, raw=None):
    print('processing note file')
    with open(notes_file, 'r') as csvfile:
        with open(out_file, 'w') as outfile:
            print('writing to %s' % (out_file))
            writer = csv.writer(outfile)
            heads = {'Column1': 'SUBJECT_ID', 'Column2': 'HADM_ID', 'Column3': 'CHARTTIME', 'Column4': 'TEXT'}
            ...
            for line in tqdm(notereader):
                ...
                if category == 'Discharge summary':
                    note = line[10]
                    row = {'Column1': line[1], 'Column2': line[2], 'Column3': line[4], 'Column4': note}
